...
@section('js')
    {{ HTML::script('dropzone.min.jsn.js') }}
    {{ HTML::script('packages/mobytes/landpage/js/summernote/summernote.min.js') }}
    <script>
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            {{Former::horizontal_open( route('landpage.publicaciones.store') )}}
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="mail-box">
                                ...
                                <div class="mail-body text-right tooltip-demo">
                                    ...
                                    <a href="{{URL::previous()}}" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Descartar Publicaci&oacute;n"><i class="fa fa-times"></i> Descartar</a>
                                </div>
                                <div class="clearfix"></div>
