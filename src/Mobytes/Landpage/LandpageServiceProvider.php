...
use Mobytes\Landpage\core\ValidatorExtended;
...
class LandpageServiceProvider extends ServiceProvider
{
    ...
    {
        $app = $this->app;
        $app->bind('Mobytes\Landpage\Objective\Repo\ObjectiveInterface', function ($app) {
    ...
    public function registerPublication()
    {
        ...
        $app->bind('Mobytes\Landpage\Publication\Repo\PublicationInterface', function ($app) {
            return new PublicationRepository(new Publication(), new Media());
        });
    }
