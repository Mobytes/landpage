 ...
 */
class OrganizationCommandHandler implements CommandHandler
{
    /**
     * @autor eveR Vásquez
    ...
    /**
     * OrganizationCommandHandler constructor.
     * @param $repository
     */
    public function __construct(OrganizationInterface $repository)
    {
